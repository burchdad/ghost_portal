...
export const rolePermissions: Record<Role, Permission[]> = {
  ...
  Support: ["academy:read", "clients:read:assigned", "clients:update:notes", "feedback:read", "knowledge:read", "reports:submit", "support:create", "support:triage", "tasks:read:assigned", "tasks:update:assigned"],
