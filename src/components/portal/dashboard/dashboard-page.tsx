    ...
    <section className="px-5 py-7 lg:px-8">
      <div className="mb-7 grid gap-5 xl:grid-cols-[1fr_360px] xl:items-start">
        ...
        <div className="grid gap-3">
          <TimeClockCard clock={snapshot.currentUserTimeClock} timezone={snapshot.currentUserTimeClock.subjectTimezone} />
          {snapshot.currentUserTimeClock.subjectName !== snapshot.timeClock.subjectName ? <TimeClockCard clock={snapshot.timeClock} timezone={snapshot.timeClock.subjectTimezone} /> : null}
